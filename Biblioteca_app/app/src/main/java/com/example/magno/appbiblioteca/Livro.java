...
public class Livro {
	...
	//private String disponivel; TODO Campo para verifica��o de reserva
	...
	public Livro(String titulo, String genero, String tomo, String autor, String edicao, String editora, String anoDeEdicao, String volume, String estante /*String disponivel*/) {
		...
		//this.disponivel = disponivel; TODO Campo para verifica��o de reserva
...
/* TODO Campo para verifica��o de reserva
